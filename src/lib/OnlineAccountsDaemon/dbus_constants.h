...
#define ONLINE_ACCOUNTS_AUTH_KEY_MECHANISMS "Mechanisms"
#define ONLINE_ACCOUNTS_AUTH_KEY_FQDN "Fqdn"
#define ONLINE_ACCOUNTS_AUTH_KEY_LOCAL_IP "LocalIp"
#define ONLINE_ACCOUNTS_AUTH_KEY_REMOTE_IP "RemoteIp"
